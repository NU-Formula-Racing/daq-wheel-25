#ifndef __WHEEL_TEMP_H__
#define __WHEEL_TEMP_H__
...
private:
    ...
    enum class State : uint8_t { SEEK_PREAMBLE, COLLECT_FRAME }; //storing state of parsing
    ...
    static constexpr size_t FRAME_LEN       = sizeof(TempPacket); //change to whatever kris did
